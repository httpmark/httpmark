...
export const setConnectionMapping = (existingPorts, newPort) => (context, tabId) => {
...
export const createMessageBus = (devtools, content) => {
  const registerDevToolsMessageListener = devtool => websocket => {
    devtool.onMessage.addListener(({ status, payload }) => {
